        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('organization.update',['id'=>$data->id]) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @endif
                                    @if($data->image!=null)
                                        <img src="{{url('assets/images/org-logo/'.$data->image)}}" style="height: 80px;">
                                    @endif
                                </div>
