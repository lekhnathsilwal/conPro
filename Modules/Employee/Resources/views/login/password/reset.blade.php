                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{route('employee.update.emp.password',['id'=>$data->id])}}" method="post">
                                        @csrf
                                        ...
                                        <input type="submit" class="btn btn-primary btn-user btn-block" value="Update Password"><br>
                                        <a href="{{route('employee.login')}}" class="btn btn-primary btn-user btn-block">Login Panel</a>
